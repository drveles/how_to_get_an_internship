...
- Скрининги — это быстрая проверка на адекватность и заинтересованность.  
- HR-собесы — это проверка софтов, планов на работу, бэкграунда и немного хардов. Часто недооценивают эти собесы, а зря. Ведь именно рекрутёр тебя будет продавать командам.  
...
- Лайвкодинги - похожая штука, но там решаются не алгоритмы, а вообще любая прикладная задачка. Например, написать класс животное и отнаследовать кошек и собак. Часто решается в IDE.  
