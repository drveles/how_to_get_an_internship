# Сборник полезных ссылок - как попасть на стажировку

Ссылки подготовленный для выступления с [презентацией](./Как%20попасть%20на%20стажировку%20в%20Яндекс.pdf) поэтому они разбиты на смысловые блоки из неё.
Ищи нужные с помощью сочетания клавиш (`CTRL + F` или `CMD + F`) или через оглавление.
...
Если хочешь добавить что-то в этот список – напиши [мне](https://t.me/drveles) или сделай [pull request](https://codex.so/fork-and-pull) в этот репозиторий.
