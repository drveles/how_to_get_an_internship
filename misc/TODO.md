...
- После выступления:
  - [not] Финальную презу в PDF залить на гит с ссылками для клика + поправить второй слайд
  - [x] Добавить её в Readme
  - [ ] Сделать расшифровку выступления
    - [x] Проверить на орфографию и пунктуацию с помощью ИИ
    - [x] Попробовать улучшить структуру с помощью ИИ
    - [x] Добавить footer
    - [x] Отдать на гострайтинг
      - [ ] Править замечания
  - [ ] Опубликовать текстовую версию
  - [ ] Раскатить промо на два кампуса
  - [ ] Сделать и опубликовать статью на хабр
  - [ ] Удалить этот файл по окончанию статьи
